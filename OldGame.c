...
#include "oldOutput.h"
#include "oldOperationsOnArrays.h"
#include "oldMinMax.h"
#include "oldHEX.h"
#include "oldCheckState.h"
#include "oldgeneticAlgorithm.h"

int main() {
#include <time.h>
	//TODO load from file
	int awards1[numberOfAwards] = { 800, 2, 1, 2, 1, 3, 2, 1, 30, 1, 4 };
	int awards2[numberOfAwards] = { 800, 50, 50, 2, 1, 3, 2, 1, 5, 1, 20 };
